...
loader = PyPDFLoader("/home/will/Documents/Will/papers/2023_GPTQ_Accurate Post-Training Quantization For Generative Pre-Trained Transformers.pdf")
...
db = Chroma.from_documents(pages, HuggingFaceEmbeddings(), persist_directory='/home/will/db')
